...
export const getDeepMergedContractCopy = (
  userInstance: unknown,
  transporterInstance: unknown,
  orderInstance: unknown,
  distributorInstance: unknown,
  retailerInstance: unknown
) => {
  return _.cloneDeep(
    _.merge(
      _.merge(
        _.merge(
          _.merge(_.cloneDeep(userInstance), _.cloneDeep(transporterInstance)),
          _.cloneDeep(orderInstance)
        ),
        _.cloneDeep(distributorInstance)
      ),
      _.cloneDeep(retailerInstance)
    )
  );
};
